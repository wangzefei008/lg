            ...
            <div class="content_l">
            	<dl class="job_detail">
                    <dt>
                        <h1 title="产品经理">
                            <em></em>
                            <div><?php echo e($job['companyname']); ?></div>
                           	<?php echo e($job['category_cn']); ?>
                    ...
                    <dd class="job_request">
                    	<span class="red"><?php echo e($job['salaryMin']); ?>k-<?php echo e($job['salaryMax']); ?>k</span>
                       	<span><?php echo e($job['district_cn']); ?></span> 
                       	<span><?php echo e($job['experience_cn']); ?> </span>
                       	<span><?php echo e($job['education_cn']); ?></span> 
                       	<span><?php echo e($job['nature_cn']); ?></span><br>
                      	  职位诱惑 : <?php echo e($job['tag_cn']); ?>

                      	<div>发布时间：<?php echo e(date('Y-m-d H:i:s',$job['addtime'])); ?></div>
                    </dd>
                    <dd class="job_bt">
	                ...
	                <dd class="resume resume_web">
				        <div>
							<span> 你已有可投递的在线简历：<a title="" target="_blank" href="jianli.html"><strong><?php echo e($email); ?></strong></a></span><br>
                ...
                <dl class="job_company">
                    <dt>
                    	<a target="_blank" href="h/c/5004.html">
                            <img width="80" height="80" alt="广州百田信息科技有限公司" src="<?php echo e($job['logo']); ?>" class="b2">
                            <div>
                                <h2 class="fl">
                    ...
                    <dd>
                    	<ul class="c_feature reset">
                        	<li><span>领域</span> <?php echo e($job['trade_cn']); ?></li>
                        	<li><span>规模</span> <?php echo e($job['scale_cn']); ?>人</li>
                        	<li>
                        		<span>主页</span> 
            		...
            		<ul class="reset">
            		<?php foreach($connect as $k=>$v): ?>
            			<li>
            				<a target="_blank" href="h/jobs/148004.html">
								<span class="f14"><?php echo e($v['category_cn']); ?></span>
								<span class="c7"><?php echo e($v['companyname']); ?></span>
								<em>92%</em>
							</a>
            			</li>
            		<?php endforeach; ?>
	        	...
	        	<td>
                    <form class="resumeSetForm" id="resumeSetForm">
	            		<label class="radio">
	            			...
	            			在线简历：
	            			<span title="jason的简历"><?php echo e($email); ?></span>
	            		</label>
            			<div class="setBtns">
	    	...
	    	<tr>
	        	<td>
                    <form class="resumeSetForm" id="resumeSendForm" >
	            		...
	            		<div class="clear"></div>
	            		<label class="radio">
	            			<input type="radio" value="<?php echo e($v['id']); ?>" class="resume0" name="resumeName">
