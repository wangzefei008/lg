            ...
            <div class="content">
            	<dl class="company_center_content">
                    <dt>
                        <h1>
                            <em></em>
                                                                                    有效职位  <span>（共<?php echo e($count); ?>份）</span>                        </h1>
                    </dt>
                    <dd>
                    	<form action="autoFilterResumes.html" method="get" id="filterForm">
   <!--  循环展示start   -->                     	                        		 <?php foreach($data as $k=>$v): ?>                      
	<ul class="reset resumeLists">
		<li data-id="1686182" class="onlineResume">
		    <div class="resumeShow">
		            ...
		            <div> 
		            	<?php echo e($v['jobs_name']); ?>	                                        		<br>
		                	<?php echo e($v['category_cn']); ?>  | <?php echo e($v['education_cn']); ?> 
		                			                                        </div>
		            <div class="jdpublisher">
		                <span>
		                	应聘职位：<a title="随便写" target="_blank" href="http://www.lagou.com/jobs/149594.html"><?php echo e($v['nature_cn']); ?></a>
		               						                                        </span>
		            </div>
		        </div>
		        <div class="links">
	...
	<!--  循环展示end   -->
	<?php endforeach; ?>	                            		                    	<!-- end .resumeLists -->
