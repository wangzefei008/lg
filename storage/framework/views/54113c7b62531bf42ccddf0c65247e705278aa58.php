                    ...
                    <form id="searchForm">
                        ...
                        <ul class="reset my_jobs">
                            <?php foreach($data as $key=>$val): ?>
                                <li data-id="149594">
                                    <span class="receivedResumeNo"><a href="<?php echo e(URL::to('del_pms').'?'.http_build_query(['pmid'=>$val['pmid']])); ?>">删除</a></span>
                                    <div>消息内容：<?php echo e($val['message']); ?></div>
                                    <div>时间:<?php echo e(date('Y-m-d',$val['dateline'])); ?></div>
                                    <?php endforeach; ?>
                                </li>
                        </ul>
                    </form>
