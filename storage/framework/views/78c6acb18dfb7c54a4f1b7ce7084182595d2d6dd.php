		...
		<select id="aa">
            ...
            <ul class="hot_pos reset">
	            ...
	            <li class="odd clearfix">
			        <div class="hot_pos_l">
			            <div class="mb10">
			                <a href="toudi?j_id=<?php echo e($v['id']); ?>" title="前端开发" target="_blank"><?php echo e($v['category_cn']); ?></a> 
			                &nbsp;
					...
					<div class="hot_pos_r">
			            ...
			            <div class="mb10"><a href="toudi?j_id=<?php echo e($v['id']); ?>" title="紫色医疗" target="_blank"><?php echo e($v['companyname']); ?></a></div>
