            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	...
                    	<form method="post" action="<?php echo e(URL::to('company_add')); ?>">
                            <table class="btm">
                            	<tbody><tr>
                            	...
                            	<tr>
                                	...
                                	<td>职位名称</td>
                                	<td>
                                    	<input type="text" placeholder="请输入职位名称，如：产品经理" value="" name="category_cn" id="positionName">
                                    	                                    </td>
                                </tr>
                            	<tr>
                                	<td></td>
                                	<td>所属部门</td>
                                	<td>
                                    	<input type="text" placeholder="请输入所属部门" value="" name="trade_cn" id="department">	
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">工作性质</td>
                                	<td>
                                    	<input type="radio" name="nature_cn" value="全职">全职
                                    	<input type="radio" name="nature_cn" value="兼职">兼职
                                    	<input type="radio" name="nature_cn" value="实习">实习
                                    </td>
                                </tr>
                            	<tr>
                                	<td><span class="redstar">*</span></td>
                            	...
                            	<tr>
                                	...
                                	<td>工作城市</td>
                                	<td>
                                    	<input type="text" placeholder="请输入工作城市，如：北京" value="上海" name="district_cn" id="workAddress">
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">工作经验</td>
                                	<td>
                                        <input type="radio" name="experience_cn" value="不限">不限
                                        <input type="radio" name="experience_cn" value="应届生">应届生
                                        <input type="radio" name="experience_cn" value="一年以下">一年以下
                                        <input type="radio" name="experience_cn" value="三年以下">三年以下
                                        <input type="radio" name="experience_cn" value="五年以下">五年以下
                                        <input type="radio" name="experience_cn" value="五年以上">五年以上
                                    </td>
                                </tr>
                            	<tr>
                                	<td><span class="redstar">*</span></td>
                                    ...
                                    <!--<h3><span>(最高月薪不能大于最低月薪的2倍)</span></h3> -->
                                	<td>
                                    	<input type="radio" name="education_cn" value="不限">不限
                                    	<input type="radio" name="education_cn" value="大专">大专
                                    	<input type="radio" name="education_cn" value="本科">本科
                                    	<input type="radio" name="education_cn" value="硕士">硕士
                                    	<input type="radio" name="education_cn" value="博士">博士
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">职位诱惑</td>
                                	<td>
                                    	<input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" value="" name="tag_cn" class="input_520" id="positionAdvantage">
                                    </td>
                                </tr>
                            	<tr>
                                	<td><span class="redstar">*</span></td>
                            ...
                            <table>
                            	<tbody><tr>
                                	<td width="25"><span class="redstar">*</span></td>
                                	<td colspan="2">
                                    	接收简历邮箱： <span id="receiveEmailVal"><?php echo e($email); ?></span>
                                        <input type="hidden" value="<?php echo e($email); ?>" id="receiveEmail" name="email">
                                    </td>
                                </tr>
                                <tr>
                                	<td width="25"></td>
                                ...
                                <tr>
                                	<td width="25"></td>
                                	<td colspan="2">
                                		<a href="<?php echo e(URL::to('company')); ?>">返回</a>
