	                ...
	                <div class="c_detail">
	                	<div style="background-color:#fff;" class="c_logo">
		                	<a title="上传公司LOGO" id="logoShow" class="inline cboxElement" href="#logoUploader">
		                				                			<img width="190" height="190" alt="公司logo" src="<?php echo e($data[0]['logo']); ?>">
	                    ...
	                    <div class="c_box companyName">
	                    		                   			<h2 title="<?php echo e($data[0]['companyname']); ?>"><?php echo e($data[0]['companyname']); ?></h2>
	                        	...
	                        	<a target="_blank" class="applyC" href="http://www.lagou.com/c/auth.html">申请认证</a>
	                        	                        <div class="clear"></div>
	                       		                   			...
	                       		                   			<h1 title="福建平潭协创进出口贸易有限公司" class="fullname"><?php echo e($data[0]['companyname']); ?></h1>
	                        ...
	                        <div class="clear oneword"><img width="17" height="15" src="style/images/quote_l.png">&nbsp; <span><?php echo e($data[0]['contents']); ?></span> &nbsp;<img width="17" height="15" src="style/images/quote_r.png"></div>
       				...
       				<div id="Product">
	        					...
	        					<div class="product_wrap">
					                    ...
					                    <dd>
					                        <form method="post" class="productForm">
					                            ...
					                            <div class="cp_intro">
					                                ...
					                                <textarea placeholder="请简短描述该产品定位、产品特色、用户群体等" maxlength="500" value="<?php echo e($data[0]['trade_cn']); ?>" class="s_textarea" name="productProfile"><?php echo e($data[0]['trade_cn']); ?></textarea>	
					                ...
					                <dl class="c_product">
					                    ...
					                    <dd>
					                    	<img width="380" height="220" alt="<?php echo e($data[0]['nature_cn']); ?>" src="style/images/product_default.png">
				                        	<div class="cp_intro">
				                        						                        		<h3><a target="_blank" href="http://www.weimob.com"><?php echo e($data[0]['nature_cn']); ?> </a></h3>
					                            <div class="scroll-pane" style="overflow: hidden; padding: 0px; width: 260px;">
					                            	
					                            <div class="jspContainer" style="width: 260px; height: 140px;"><div class="jspPane" style="padding: 0px; top: 0px; width: 260px;"><div><?php echo e($data[0]['trade_cn']); ?></div></div></div></div>
					                        </div>
       				...
       				<div id="Profile">
					                ...
					                <dl class="c_section newIntro dn">
					                    ...
					                    <dd>
						                    <form id="companyDesForm">
						                        <textarea placeholder="请分段详细描述公司简介、企业文化等" name="companyProfile" id="companyProfile"><?php echo e($data[0]['contents']); ?></textarea>		                                        
					            ...
					            <!--有介绍-->
					               <dl class="c_section">
					                   	...
					                   	<dd>
					                   		<div class="c_intro"><?php echo e($data[0]['contents']); ?></div>
						...
						<dl id="noJobs" class="c_section">
		                    ...
		                    <dd>
		                    	<div class="addnew">
		                            ...
		                            <a href="<?php echo e(URL::to('company_create')); ?>">+添加招聘职位</a>
		                        </div>
		                    </dd>
		                </dl>
