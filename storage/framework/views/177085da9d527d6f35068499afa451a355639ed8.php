    ...
    <div id="container">
            ...
            <div class="content_l">
                    ...
                    <dd class="job_request">
						<span class="red">居住地：<?php echo e($residence); ?></span>
						<span>工作经验：<?php echo e($experience_cn); ?></span>
						<span>学历：<?php echo e($education_cn); ?></span><br/>
						<span> 工作性质：<?php echo e($nature_cn); ?></span>
						<span>婚姻状况：<?php echo e($marriage_cn); ?></span>
						<span>籍贯：<?php echo e($householdaddress); ?> </span><br/>
						<span>期望薪资：<?php echo e($wage_cn); ?></span>
						<span>所学专业：<?php echo e($major_cn); ?></span><br/>
						<span>身高：<?php echo e($height); ?></span>
						<span> 期望职位：<?php echo e($intention_jobs); ?></span>
						<br/>
						·&nbsp;手机 : <?php echo e($telephone); ?><br/>
						·&nbsp;邮箱 : <?php echo e($email); ?><br/>
						·&nbsp;出生年份 : <?php echo e($birthdate); ?><br/>
						·&nbsp;特长: <?php echo e($tag_cn); ?>

						<div>发布时间：<?php if(floor((time()-$addtime)/3600/24)==0): ?>
								<?php echo e('今天发布'); ?>

							<?php else: ?> <?php echo e(floor((time()-$addtime)/3600/24)); ?>天前发布</span>
							<?php endif; ?></div>
                    </dd>
                    <dd class="job_bt">
                        <h3 class="description">自我描述：</h3>
							<p style="margin-left: 50px;"><?php echo e($specialty); ?></p>
                    </dd>
