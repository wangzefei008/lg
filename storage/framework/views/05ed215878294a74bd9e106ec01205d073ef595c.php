                        ...
                        <ul class="reset my_jobs">
                            <?php foreach($data as $key=>$val): ?>
                                <li data-id="149594">
                                    ...
                                    <span class="receivedResumeNo"><a href="<?php echo e(URL::to('del_favorites').'?'.http_build_query(['did'=>$val['did']])); ?>">删除</a></span>
                                    <div>工作地区：<?php echo e($val['district_cn']); ?>  &nbsp;&nbsp;&nbsp;&nbsp;  薪资待遇：<?php echo e($val['wage_cn']); ?>&nbsp;&nbsp;&nbsp;&nbsp;  收藏时间：<?php echo e(date('Y-m-d',$val['addtime'])); ?></div>
                                    <?php endforeach; ?>
                                </li>
                        </ul>
                    </form>
