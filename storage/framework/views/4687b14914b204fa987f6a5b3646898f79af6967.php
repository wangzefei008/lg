    ...
    <div id="header">
        <div class="wrapper">
            ...
            <ul class="reset" id="navheader">
                <li <?php if($status == 1): ?> class="current" <?php endif; ?>><a href="<?php echo e(URL::to('/')); ?>">首页</a></li>
                <li <?php if($status == 2): ?> class="current" <?php endif; ?> ><a href="<?php echo e(URL::to('companylist')); ?>" >公司</a></li>
                <li <?php if($status == 3): ?> class="current" <?php endif; ?>><a href="<?php echo e(URL::to('job_list')); ?>" >招聘信息</a></li>
                <li <?php if($status == 4): ?> class="current" <?php endif; ?>><a href="<?php echo e(URL::to('hotmore')); ?>" >求职信息</a></li>
            </ul>
             <?php if(!empty($email)): ?>
