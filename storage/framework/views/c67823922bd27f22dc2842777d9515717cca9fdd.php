    ...
    <div id="container">
        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <dd>
                    <form action="create_resume_do" method="post" >
                        <table class="btm">
                            <tbody>
                            <tr>
                                ...
                                <td>简历名称</td>
                                <td>
                                    <input type="text" placeholder="请输入简历名称" value="" name="title" id="positionName">
                                </td>
                            </tr>
                            <tr>
                                <td><span class="redstar">*</span></td>
                                <td>姓名</td>
                                <td>
                                    <input type="hidden" value="<?php echo e($uid); ?>" name="uid">
                                    <input type="text" placeholder="请输入名称" value="" name="fullname" id="positionName">
                                </td>
                            </tr>
                            <tr>
                                <td><span class="redstar">*</span></td>
                        ...
                        <table class="btm">
                            ...
                            <tr>
                                ...
                                <td>手机</td>
                                <td>
                                    <input type="text" placeholder="请输入手机号" value="" name="telephone" id="positionName">
                                </td>
                            </tr>
                            <tr>
                                <td><span class="redstar">*</span></td>
                            ...
                            <tr>
                                ...
                                <td>期望行业 </td>
                                <td>
                                    <input type="text"  value="" name="trade_cn" id="positionName">
                                </td>
                            </tr>
                            <tr>
                                <td><span class="redstar">*</span></td>
                                <td>期望薪资 </td>
                                <td>
                                    <input type="text"  value="" name="wage_cn" id="positionName">
                                </td>
                            </tr>
                            <tr>
                                <td><span class="redstar">*</span></td>
                                <td>期望职位   </td>
                                <td>
                                    <input type="text"  value="" name="intention_jobs" id="positionName">
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>教育经历：</td>
                                <td><textarea name="education_urdergo"  id="positionName"></textarea></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>工作经历：</td>
                                <td><textarea name="work_urdergo"  id="positionName"></textarea></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>自我描述：</td>
                                <td><textarea name="portrait"  id="positionName"></textarea></td>
                            </tr>
                            </tbody></table>
                        <table>
                            <tbody>
