...
<body id="login_bg">
	<div class="login_wrapper">
		...
		<div class="login_box">
        	<form id="loginForm" method="post" action="register_do">
            	...
            	<label class="fl registerJianJu" for="checkbox">
            		<input type="checkbox" id="checkbox"  checked  class="checkbox valid" />我已阅读并同意<a href="h/privacy.html" target="_blank">《拉勾用户协议》</a>
           		</label>
                <input type="submit" id="submitLogin" value="注 &nbsp; &nbsp; 册" />
            </form>
            <div class="login_right">
            	<div>已有拉勾帐号</div>
            	<a  href="<?php echo e(URL::to('login')); ?>"  class="registor_now">直接登录</a>
