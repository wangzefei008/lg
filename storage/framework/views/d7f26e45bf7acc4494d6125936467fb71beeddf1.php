                    ...
                    <form id="searchForm">
                        ...
                        <ul class="reset my_jobs">
                            <?php foreach($data as $key=>$val): ?>
                                <li data-id="149594">
                                    <h3>
                                        <a target="_blank" title="职位名称" href="">职位名称：<?php echo e($val['jobs_name']); ?></a>
                                    </h3>
                                    <span class="receivedResumeNo"><a href="<?php echo e(URL::to('del_apply').'?'.http_build_query(['did'=>$val['did']])); ?>">删除</a></span>
                                    <div>公司名称：<?php echo e($val['company_name']); ?>  &nbsp;&nbsp;&nbsp;&nbsp;简历名称：<?php echo e($val['resume_name']); ?>  &nbsp;&nbsp;&nbsp;&nbsp;  投递时间：<?php echo e(date('Y-m-d',$val['apply_addtime'])); ?></div>
                                    <?php endforeach; ?>
                                </li>
                        </ul>
                    </form>
