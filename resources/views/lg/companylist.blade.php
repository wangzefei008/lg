	                       ...
	                       <!--  <h2 class="fl">热门公司</h2> -->
	                        <ul class="workplace reset fr" id="workplaceSelect">
								...
								@foreach($data_city as $k=>$v)
										...
										@if($v['level'] == 0  && $v['id']<=8)
	                                                            <li >
                                	<a href="javascript:;" >{{ $v['categoryname'] }}</a> 
                                	                                	|
                                	                                </li>
                                	    @endif
	                            @endforeach
					            	...
					            	<span class="top"></span>
							    			...
							    			<dd>
												@foreach($data_city as $k=>$v)
												@if($v['level'] == 0)
												<a href="javascript:;"  class="current" >{{ $v['categoryname'] }}</a>
												@else 
												<a href="javascript:;" >{{ $v['categoryname'] }}</a>
							     				@endif
												@endforeach
	                        ...
	                        <dl>
	                            ...
	                            @endforeach
	               	                	...
	               	                	<ul class="hc_list reset">
											@foreach($data_profile as $k=>$v)
		                  		        	<li @if($k%3==0) style="clear:both;" @endif >
