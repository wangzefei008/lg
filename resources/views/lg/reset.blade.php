	...
	<div class="login_wrapper">
    	...
    	<input type="hidden" id="resubmitToken" value="" />
     	<div class="find_psw">
            ...
            <form id="pswForm" action="reset_pwd" method="post">
            	<input type="text" name="email" id="email" placeholder="请输入注册时使用的邮箱地址" />
				<input type="button" value="发送验证码" style='width:100px;height: 40px;' id='send'/>          		
            	<input type="text" name="code" id='code' placeholder="请输入收到的验证码" >       		          
            	<br><span id='check'></span><br>		
            	<input type="text" name="password" id='password' placeholder="请输入新密码" >
