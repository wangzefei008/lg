...
<div id="container">
    ...
    <div class="content">
        <dl class="company_center_content">
            ...
            <dd>
                <form action="person_updatedo" method="post" >
                    ...
                    <table class="btm">
                        ...
                        <tr>
                            ...
                            <td>真实姓名：</td>
                            <td>
                                <input type="text" placeholder="请输入名称" value="{{$realname}}" name="realname" id="positionName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="redstar">*</span></td>
                    ...
                    <table class="btm">
                        ...
                        <tr>
                            ...
                            <td>手机</td>
                            <td>
                                <input type="text" placeholder="请输入手机号" value="{{$phone}}" name="phone" id="positionName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="redstar">*</span></td>
