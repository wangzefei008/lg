...
<div id="container">
    ...
    <div class="content">
        <dl class="company_center_content">
            ...
            <dd>
                <form action="update_resume_do" method="post" >
                    <table class="btm">
                        <tbody>
                        <tr>
                            ...
                            <td>简历名称</td>
                            <td>
                                <input type="text" placeholder="请输入简历名称" value="{{$title}}" name="title" id="positionName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="redstar">*</span></td>
                            ...
                            <td>
                                ...
                                <input type="text" placeholder="请输入名称" value="{{$fullname}}" name="fullname" id="positionName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="redstar">*</span></td>
                        ...
                        <tr>
                            ...
                            <td width="85">出生年月</td>
                            <td>
                                <input type="hidden" id="experience" value="" name="birthdate">
                        ...
                        <tr>
                            ...
                            <td>现在居住地</td>
                            <td>
                                <input type="text" placeholder="请输入地址" value="{{$residence}}" name="residence" id="positionName">
                            </td>
                        </tr>
                        </tbody></table>
                    ...
                    <table class="btm">
                        ...
                        <tr>
                            ...
                            <td>所学专业</td>
                            <td>
                                <input type="text" placeholder="请输入专业" value="{{$major_cn}}" name="major_cn" id="positionName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="redstar">*</span></td>
                        ...
                        <tr>
                            ...
                            <td>手机</td>
                            <td>
                                <input type="text" placeholder="请输入手机号" value="{{$telephone}}" name="telephone" id="positionName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="redstar">*</span></td>
                            <td>邮箱</td>
                            <td>
                                <input type="text"  value="{{$email}}" name="email" id="positionName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="redstar">*</span></td>
                            <td>身高</td>
                            <td>
                                <input type="text"  value="{{$height}}" name="height" id="positionName" placeholder="单位厘米">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="redstar">*</span></td>
                            <td>籍贯</td>
                            <td>
                                <input type="text"  value="{{$householdaddress}}" name="householdaddress" id="positionName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="redstar">*</span></td>
                        ...
                        <tr>
                            ...
                            <td>期望行业 </td>
                            <td>
                                <input type="text"  value="{{$trade_cn}}" name="trade_cn" id="positionName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="redstar">*</span></td>
                            <td>期望薪资 </td>
                            <td>
                                <input type="text"  value="{{$wage_cn}}" name="wage_cn" id="positionName">
                            </td>
                        </tr>
                        <tr>
                            <td><span class="redstar">*</span></td>
                            <td>期望职位   </td>
                            <td>
                                <input type="text"  value="{{$intention_jobs}}" name="intention_jobs" id="positionName">
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>教育经历：</td>
                            <td><textarea name="education_urdergo" >{{$education_urdergo}}</textarea></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>工作经历：</td>
                            <td><textarea name="work_urdergo" >{{$work_urdergo}}</textarea></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>自我描述：</td>
                            <td><textarea name="portrait" >{{$portrait}}</textarea></td>
                        </tr>
                        </tbody></table>
                    <table>
                        <tbody>
