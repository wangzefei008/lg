...
<div id="previewWrapper">
    <div class="preview_header">
        ...
        <a title="返回" class="inline cboxElement" href="{{URL::to('my_resume')}}">返回</a>
    ...
    <div class="preview_content">
        <div class="profile_box" id="basicInfo">
            <h2>基本信息</h2>
            <div class="basicShow">
                   <span>{{$fullname}}&nbsp;/&nbsp;{{$sex_cn}}&nbsp;/&nbsp;{{$education_cn}}&nbsp;/&nbsp;{{$experience_cn}}&nbsp;/&nbsp;{{$residence}}<br>
                       {{$telephone}} / {{$email}}<br>
            		</span>
        ...
        <div class="profile_box" id="expectJob">
            ...
            <div class="expectShow">
                期望薪资：{{$wage_cn}}<br>期望职位：{{$intention_jobs}}
            </div><!--end .expectShow-->
        </div><!--end #expectJob-->
