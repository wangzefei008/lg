                        ...
                        <ul class="reset my_jobs">
                            @foreach($data as $key=>$val)
                                <li data-id="149594">
                                    ...
                                    <span class="receivedResumeNo"><a href="{{URL::to('del_favorites').'?'.http_build_query(['did'=>$val['did']])}}">删除</a></span>
                                    <div>工作地区：{{$val['district_cn']}}  &nbsp;&nbsp;&nbsp;&nbsp;  薪资待遇：{{$val['wage_cn']}}&nbsp;&nbsp;&nbsp;&nbsp;  收藏时间：{{date('Y-m-d',$val['addtime'])}}</div>
                                    @endforeach
                                </li>
                        </ul>
                    </form>
