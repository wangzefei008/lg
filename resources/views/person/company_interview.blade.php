                ...
                <dd>
                    <form id="searchForm">
                        ...
                        <ul class="reset my_jobs">
                            ...
                            <li data-id="149594">
                                <h3>
                                    <a target="_blank" title="简历名称" href="">简历名称：{{$val->resume_name}}</a>
                                </h3>
                                <span class="receivedResumeNo"><a href="{{URL::to('del_inter').'?'.http_build_query(['did'=>$val->did])}}">删除</a></span>
                                <div>职位名称：{{$val->jobs_name}}  &nbsp;&nbsp;&nbsp;&nbsp;公司名称：{{$val->company_name}}  &nbsp;&nbsp;&nbsp;&nbsp;  面试时间：{{$val->interview_time}}</div>
                                @endforeach
                            </li>
                        </ul>
                    </form>
